...
Las páginas \pageref{chap:signos} y \pageref{chap:valores}
hacen recordar los signos y valores de la música, de la página \pageref{chap:no1}
hasta la \pageref{chap:no5} son para estudiar el teclado o sea identificar la
tecla a que nota corresponde, sin instrumento. Las páginas \pageref{chap:teclado} y \pageref{chap:teclado2} son
para examinarse el conocimiento, esto debe el alumno saber con toda exactitud.
Las páginas \pageref{chap:no5} a \todo son estudios con el instrumento para ambas manos separadas.
