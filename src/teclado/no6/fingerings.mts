...
let notesFor = (hand: Hand) => {
  let range = { left: [55, 62], right: [67, 74] };
...
await render_for("left", "open", "teclado_no6_iz_abrir.svg");
await render_for("left", "close", "teclado_no6_iz_cerrar.svg");
await render_for("right", "open", "teclado_no6_de_abrir.svg");
await render_for("right", "close", "teclado_no6_de_cerrar.svg");
