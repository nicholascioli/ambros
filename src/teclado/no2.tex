...
\begin{center}
    \includegraphics[width=0.8\textwidth]{./imgs/teclado_no2_iz_abrir}
\end{center}
...
\begin{center}
    \includegraphics[width=0.8\textwidth]{./imgs/teclado_no2_iz_cerrar}
\end{center}
...
\subsection{Notas con \sharp \hspace{0.1cm} y \flat \hspace{0.1cm} abriendo}
\begin{center}
    \includegraphics[width=0.7\textwidth]{./imgs/teclado_no2_de_abrir}
\end{center}
...
\subsection{Notas con \sharp \hspace{0.1cm} y \flat \hspace{0.1cm} cerrando}
\begin{center}
    \includegraphics[width=0.7\textwidth]{./imgs/teclado_no2_de_cerrar}
\end{center}
